    ...
    return (
      <div className="header">
        <h3>
          ...
          <span> | </span>
          <a href="https://github.com/mbfsrv/mapartcraft" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
          <span> | </span>
        ...
        <p>
          ...
          <a href="https://github.com/mbfsrv/mapartcraft/issues" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
          {"."}
          <br></br>
